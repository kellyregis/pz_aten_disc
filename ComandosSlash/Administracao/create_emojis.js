...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        try {
            ...
            await interaction.editReply({ content: "✅ Emojis adicionados com sucesso neste servidor! Lembre-se de reiniciar o bot para garantir que as alterações entrem em vigor.", ephemeral: true });
        } catch (error) {
